...
export default function Login() {
  const { loggedIn, login, showToast } = useApp();
  ...
  function handleSubmit(e) {
    e.preventDefault();
    login();
    showToast("Berhasil Masuk! Membuka dasbor...", "success");
    navigate("/beranda");
  }
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-modal rounded-2xl shadow-2xl p-8 relative overflow-hidden animate-fade-in-up z-10">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="font-bold text-2xl text-slate-850">Selamat Datang Kembali</h2>
          <p className="text-xs text-slate-500 mt-1">Masuk untuk melanjutkan simulasi bisnis Anda</p>
        </div>
